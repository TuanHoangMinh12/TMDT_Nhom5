                ...
                <div class="col-container_content">
                  ...
                  <div class="wrap_price">
                      ...
                      <div class="price active">
                          <fmt:formatNumber value="${item.value.product.priceDiscount}" type="number" groupingUsed="true"/> đ
                      </div>

                      <div class="price_sale">
                          <fmt:formatNumber value="${item.value.product.price}" type="number" groupingUsed="true"/> đ
                      </div>
...
<%--                      <div class="price_sale">${item.value.product.price} đ</div>--%>
              ...
              <td>
                <span class="col-sum_price">
                  <fmt:formatNumber value="${item.value.product.priceDiscount * item.value.quantity}" type="number" groupingUsed="true"/> đ
                </span>
              </td>
